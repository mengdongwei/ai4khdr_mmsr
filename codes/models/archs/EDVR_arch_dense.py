...
class Predeblur_ResNet_Pyramid(nn.Module):
    def __init__(self, nf=128, HR_in=False):
        ...
        basic_block = functools.partial(arch_util.ResidualDenseBlock_noBN, nf=nf)
...
class EDVR(nn.Module):
    def __init__(self, nf=64, nframes=5, groups=8, front_RBs=3, back_RBs=6, center=None,
        ...
        self.HR_in = True if HR_in else False
        self.w_TSA = w_TSA
        ResidualDenseBlock_noBN_f = functools.partial(arch_util.ResidualDenseBlock_noBN, nf=nf)
        ...
        if self.is_predeblur:
            ...
            if self.HR_in:
                ...
                self.conv_first = nn.Conv2d(3, nf, 3, 1, 1, bias=True)
        self.feature_extraction = arch_util.make_layer(ResidualDenseBlock_noBN_f, front_RBs)
        ...
        #### reconstruction
        self.recon_trunk = arch_util.make_layer(ResidualDenseBlock_noBN_f, back_RBs)
        #### upsampling
