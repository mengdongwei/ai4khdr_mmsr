...
from data_m.sampler import SequentialSampler, RandomSampler, BatchSampler
from data_m.worker import _worker_loop
...
def mixup_enhance(lrs, hrs, alpha=2):
    lam = np.random.beta(alpha, alpha)
