...
def main():
    dataset = 'DIV2K_FLICKR2K'  # vimeo90K | REDS | general (e.g., DIV2K, 291) | DIV2K_demo |test
    ...
    if dataset == 'vimeo90k':
        ...
        opt = {}
        ## GT
        opt['img_folder'] = ['/workspace/datasets/DIV2K/DIV2K_train_HR', '/workspace/datasets/FLICKR2K/Flickr2K_HR']
        opt['lmdb_save_path'] = '/workspace/datasets/DIV2K/DIV2K_train_and_FLICKR2K.lmdb'
        opt['name'] = 'DIV2K_train_and_FLICKR2K_GT'
        general_image_folder(opt)
    elif dataset == 'test':
